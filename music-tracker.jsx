        ...
        <div style={{ borderTop: "1px solid #ffffff0a", padding: "18px 18px 20px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 16 }}>
            <button onClick={onDelete} style={{
              ...
              onMouseLeave={e => { e.target.style.background = "transparent"; e.target.style.color = "#e74c3c88"; }}
            >DELETE</button>
          </div>
        </div>
      )}
    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 900, margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ marginBottom: 36 }}>
          <div style={{
            fontFamily: "'Courier New', monospace",
            fontSize: 10, letterSpacing: 6, color: "#e91e8c",
            textTransform: "uppercase", marginBottom: 8
          }}>Studio Dashboard</div>
          <h1 style={{
            margin: 0, fontSize: 38, fontWeight: 400,
            fontFamily: "Georgia, serif",
            color: "#fff",
            letterSpacing: -1,
            lineHeight: 1.1
          }}>Music Project<br /><span style={{ color: "#e91e8c", fontStyle: "italic" }}>Tracker</span></h1>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
            <FilterBtn active={filter === "all"} onClick={() => setFilter("all")} color="#e91e8c">
              ALL ({projects.length})
            </FilterBtn>
        ...
        <div style={{
          ...
          border: "1px solid #ffffff08", borderRadius: 10, overflow: "hidden",
        }}>
          {STAGES.map((stage, i) => (
            <div
              key={stage.id}
            ...
            >
              <div style={{ fontSize: 18, fontWeight: 700, color: stageCounts[stage.id] ? stage.color : "#2a2a4a" }}>
                {stageCounts[stage.id]}
              </div>
              <div style={{ fontSize: 8, fontFamily: "'Courier New', monospace", letterSpacing: 0.5, color: "#444", marginTop: 2 }}>
                {stage.short}
              </div>
            </div>
          ))}
        ...
        {/* Project cards */}
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", color: "#333", padding: "60px 0", fontStyle: "italic" }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 10, color: "#333", fontFamily: "'Courier New', monospace", letterSpacing: 1 }}>
            GOOGLE CALENDAR INTEGRATION · COMING SOON
          </span>
          <span style={{ fontSize: 10, color: "#e91e8c55", fontFamily: "'Courier New', monospace" }}>
            ◈ STUDIO OS v1.0
          </span>
        </div>
      </div>
